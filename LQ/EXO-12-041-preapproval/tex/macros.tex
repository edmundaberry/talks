...
\newcommand{\enujjWJetsMonteCarloScaleFactorNoSyst}{0.85 \pm 0.01 \text{ (stat)}}
\newcommand{\enujjTTBarMonteCarloScaleFactorNoSyst}{0.97 \pm 0.02 \text{ (stat)}}
...
% Shape uncertainties
\newcommand{\enujjWJetsShapeUncertainty}{5.9\%}
\newcommand{\enujjTTBarShapeUncertainty}{8.2\%}
\newcommand{\eejjZJetsShapeUncertainty}{8.7\%}
